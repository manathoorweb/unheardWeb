  ...
  return (
    <div className="min-h-screen bg-[#FEFEFC] p-8 md:p-12 font-nunito">
      <div className="max-w-[1200px] mx-auto">
        <h1 className="text-[40px] font-georgia font-bold text-[#0F9393] mb-12">Super Admin Dashboard</h1>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Invite Form */}
          <div className="bg-white p-10 rounded-[24px] shadow-xl border border-gray-100 flex flex-col gap-6">
            <h2 className="text-[24px] font-bold font-georgia">Invite a New Therapist</h2>
          ...
          <div className="bg-white p-10 rounded-[24px] shadow-xl border border-gray-100 flex flex-col gap-6">
            <h2 className="text-[24px] font-bold font-georgia">Existing Therapists (Admins)</h2>
                ...
                admins.map((admin) => (
                  <div key={admin.id} className="flex items-center justify-between p-4 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors">
                    <div>
                      ...
                      <p className="text-[14px] text-gray-500">{admin.qualification || 'Awaiting profile setup'}</p>
                    </div>
                    <div className="flex gap-2">
                      <div className="w-3 h-3 rounded-full bg-green-500"></div>
                      <span className="text-[12px] text-gray-400 uppercase font-black">Active</span>
                    </div>
                  </div>
                ))
              )}
